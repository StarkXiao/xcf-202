...
export const SHOP_ITEMS: ShopItemTemplate[] = [
  ...
  {
    id: 'shop_material_spirit_iron',
    name: '灵铁',
    description: '蕴含灵气的铁矿石，锻造灵品装备的基础材料。',
    type: 'material',
    rarity: 'uncommon',
    icon: '⚙️',
    color: 0x66bb6a,
  ...
  {
    id: 'shop_material_mystic_crystal',
    name: '玄晶',
    description: '蕴含神秘力量的水晶，锻造宝品装备的珍贵材料。',
    type: 'material',
    rarity: 'rare',
    icon: '💎',
    color: 0x42a5f5,
  ...
  {
    id: 'shop_material_spirit_cloth',
    name: '灵丝',
    description: '由灵蚕吐出的丝线，用于缝制防具。',
    type: 'material',
    rarity: 'uncommon',
    icon: '🧶',
    color: 0x81c784,
  ...
  {
    id: 'shop_material_silk',
    name: '天蚕丝',
    description: '天蚕丝织成的布料，坚韧无比。',
    type: 'material',
    rarity: 'rare',
    icon: '🎀',
    color: 0x4dd0e1,
  ...
  {
    id: 'shop_material_dragon_bone',
    name: '龙骨',
    description: '远古巨龙遗骨，极其珍贵，锻造仙品装备必备。',
    type: 'material',
    rarity: 'epic',
    icon: '🦴',
    color: 0xba68c8,
  ...
  {
    id: 'shop_material_phoenix_feather',
    name: '凤凰羽',
    description: '凤凰脱落的羽毛，蕴含不灭之火。',
    type: 'material',
    rarity: 'epic',
    icon: '🪶',
    color: 0xef5350,
